  ...
  if (fromUnit.unitType != UnitType.PLAYER_CONTROLLED) {
    ...
    let unit: Unit.IUnit = Unit.create(
      ...
      toSourceUnit.info.subtype,
      {
        ...
        healthMax: (toSourceUnit.unitProps.healthMax || underworld.rules.UNIT_BASE_HEALTH) * unitSummonQuantity,
        health: (toSourceUnit.unitProps.health || underworld.rules.UNIT_BASE_HEALTH) * unitSummonQuantity,
