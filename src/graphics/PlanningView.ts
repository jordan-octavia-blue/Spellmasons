...
🗡️ ${globalThis.selectedUnit.damageAsPercent ? `${Math.floor(globalThis.selectedUnit.damage * 100)}%` : txt(globalThis.selectedUnit.damage)} ${i18n(['damage'])}` : ''}${globalThis.selectedUnit.unitSubType !== UnitSubType.MELEE ? `
